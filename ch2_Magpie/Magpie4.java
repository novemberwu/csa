...
public class Magpie4
{
    ...
    private String transformIDislikeStatement(String statement)
    {
        ...
        final String KEYWORD = "dislike";
        int index = statement.indexOf(KEYWORD);
        String something = "";
        if(index != -1){
            something = statement.substring(index + KEYWORD.length());

        }


        String response = "You said, 'I dislike "+something +"'?What do you dislike about it?";
    ...
    public String getResponse(String statement)
    {
        ...
        else if(findPhrase(statement, "dislike", 0) >=0){
